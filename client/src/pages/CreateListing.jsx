        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex gap-4'>
                    <input type='file' id='images' accept='images/*'multiple className='p-3 border border-gray-500 rounded w-full'/>
                    <button className='p-3 border border-green-700 text-green-700 rounded-lg uppercase hover:shadow-lg disabled:opacity-80'>upload</button>
                </div>
